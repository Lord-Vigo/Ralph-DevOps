...
## Unicode Characters Used in This Project

| Character | Unicode | HTML Entity | Usage |
|-----------|---------|-------------|-------|
| τ (tau) | U+03C4 | `&tau;` | Site name: τ-Residuum |
| × (multiply) | U+00D7 | `&times;` | Print sizes: 16×12 |
| · (middle dot) | U+00B7 | `&middot;` | Footer separator |
| ✓ (check) | U+2713 | `&#x2713;` | "Added ✓" button state |
