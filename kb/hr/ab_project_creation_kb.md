...
Understand what is being built completely before creating any files. After reading the project idea document, interview the user about the project to ensure full understanding of the project vision. Ask clarifying questions and use non-technical language to confirm your understanding. Assist the user in clarifying and fully defining their idea and updating the idea document as things are decided. This document is just the idea for the project and not a full design document, it will be used to create the SDD in a later step.
